...
/**
 * Implementation of the perksweetConnector Connector connect page
 */
        ...
        if (context) {
            pages.config.registerOnSaveHandler((saveEvent: pages.config.SaveEvent) => {
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.PUBLIC_HOSTNAME}/perksweetConnector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
